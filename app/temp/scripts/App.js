...
var Modal = function () {
  function Modal() {
    ...
    this.closeModalX = (0, _jquery2.default)(".modal__close");
    this.events();
  }
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    this.headerLinks = (0, _jquery2.default)(".primary-nav a"); //grabs all links within any primary-nav.
  ...
  _createClass(StickyHeader, [{
    ...
    value: function createHeaderWaypoint() {
      var that = this;
      new Waypoint({
        element: this.headerTrigger[0], //The first reference in a jquery object is always the native DOM element
